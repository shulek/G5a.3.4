...
Untracked File: 
	Nachname.txt
```
5. git add Nachname.txt - git status: 
```
Changes to be committed: 
	new file: Nachname.txt
```

6. echo Nachname2 > Nachname.txt - git status: 
```
Changes not staged for commit: 
	modified: Nachname.txt
```

7. git add Nachname.txt - git status: 
```
Changes to be committed: 
	new file: Nachname.txt
```
...
Erster Commit
```
9. echo 3AHIT > Jahrgang.info - git status: 
...
10. git add \*.info - git status: 
```
Changes to be committed: 
	new file: Jahrgang.info
```
